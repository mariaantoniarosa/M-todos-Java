...
if (imc <17) {
	JOptionPane.showMessageDialog(null, "Você está muito abaixo do peso! Indice: " + imc);
}else if ((imc ==17) || (imc <= 18.49)) {
	JOptionPane.showMessageDialog(null, "Você está abaixo do peso! Indíce: "+imc);
}else if (imc<= 24.99) {
	JOptionPane.showMessageDialog(null, "Você está com o peso adequado! Indice: "+imc);
}else if (imc<= 29.99) {
	JOptionPane.showMessageDialog(null, "Você está acima do peso! Indice: "+imc );
}else if (imc<= 34.99) {
	JOptionPane.showMessageDialog(null, "Você está com obesidade tipo I! Indice: " + imc);
}else if (imc <= 39.99) {
	JOptionPane.showMessageDialog(null, "Você está com obesidade tipo II! Indice: "+imc);
}else if (imc>=40) {
	JOptionPane.showMessageDialog(null, "Você está com obesidade tipo III! Indice: " + imc);
}
	}
